...
<div class="table-responsive">
  <table id="forum-topic-<?php print $topic_id; ?>" class="forum-topic forum-topic--<?php print $topic_id; ?>">
    <thead>
    ...
    <?php foreach ($topics as $topic): ?>
      <tr class="<?php print $topic->zebra;?>">
        <td class="forum-topic__icon"><?php print $topic->icon; ?></td>
        <td class="forum-topic__title">
          <div>
      ...
      <?php else: ?>
        ...
        <td class="forum-topic__last-reply"><?php print $topic->last_reply; ?></td>
      <?php endif; ?>
      </tr>
    <?php endforeach; ?>
    </tbody>
