 ...
 */
?>
<figure id="<?php print $id; ?>" class="<?php print $classes; ?> file-<?php print $view_mode; ?>"<?php print $attributes; ?>>
    ...
    if(!empty($content['file']['#file']->external_url)) {;?>
      ...
      if (!empty($content['file']['#item']['field_file_image_alt_text'][LANGUAGE_NONE][0]['value'])) {
        print '<figcaption class="legende">' . $content['file']['#item']['field_file_image_alt_text'][LANGUAGE_NONE][0]['value'] . '</figcaption>';
      }
    }
    ?>
