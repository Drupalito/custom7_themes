...
?>
<div class="poll-bars">
  <div class="poll-bars__text"><p class="my-0"><span class="bold"><?php print $title; ?></span> - <small class="poll-bars__percent"><?php print $percentage; ?>% (<?php print format_plural($votes, '1 vote', '@count votes'); ?>)</small></p></div>
